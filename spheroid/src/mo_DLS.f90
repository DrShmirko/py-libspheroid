MODULE mo_DLS
  ...
  implicit none
  integer(C_INT), BIND(C) :: key, key_RD, keyEL, keySUB, keyLS,&
       & key_org, key_fx, key_grid1, key_RD1, KN, KM, KR, NRATN, NDP 

  real(C_FLOAT), BIND(C) :: WL, RN, RK, pomin, pomax, xext, xabs,&
       & xsca, albedo
  ...
  real(C_FLOAT), dimension (KMpar), BIND(C) :: f11, f12, f22, f33,&
       & f34, f44
